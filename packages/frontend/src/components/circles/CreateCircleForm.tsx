...
export function CreateCircleForm({ factoryAddress, tokenAddress }: CreateCircleFormProps) {
    ...
    <div>
      ...
      {step === 1 && (
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">Number of Members</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">Contribution per Cycle (USDC)</label>
            <div className="flex gap-2 flex-wrap">
